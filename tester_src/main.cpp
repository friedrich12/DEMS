...
int main(int argc, char const *argv[]) {
  ...
  sockfd = mix.create_socket(AF_INET,SOCK_DGRAM,"127.0.0.1",8009,&sa);
  ...
  "Hello, world!",inet_ntoa(addr->sin_addr),ntohs(addr->sin_port),inet_ntoa(mn_addr->sin_addr),ntohs(mn_addr->sin_port));
